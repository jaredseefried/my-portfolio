        ...
        <div className="col-xs-12 col-md-12 col-lg-4 card-div">
          <div className="card portfolio-card">
            ...
            <div className="card-body">
              ...
              <a href="https://github.com/jaredseefried/covid19-pandemic-tracker" target="_blank" rel="noreferrer" ><FiGithub className="github-link" /></a>
            </div>
          </div>
        </div>
        <div className="col-xs-12 col-md-12 col-lg-4 card-div">
          <div className="card portfolio-card">
            ...
            <div className="card-body">
              ...
              <a href="https://github.com/jaredseefried/shelf-indulgence" target="_blank" rel="noreferrer" ><FiGithub className="github-link" /></a>
            </div>
          </div>
        </div>
        <div className="col-xs-12 col-md-12 col-lg-4">
          <div className="card portfolio-card">
            ...
            <div className="card-body">
              ...
              <a href="https://github.com/jaredseefried/meal_matcher_javascript_ajax" target="_blank" rel="noreferrer" ><FiGithub className="github-link" /></a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="col-xs-12 col-md-6 col-lg-6 col-xl-3">
          <div className="card portfolio-card">
            ...
            <div className="card-body">
              ...
              <a href="https://github.com/jaredseefried/socket.io-chat-app" target="_blank" rel="noreferrer" ><FiGithub className="github-link" /></a>
            </div>
          </div>
        </div>
        <div className="col-xs-12 col-md-6 col-lg-6 col-xl-3">
        ...
        <div className="col-xs-12 col-md-6 col-lg-6 col-xl-3 card-div">
          <div className="card portfolio-card">
            ...
            <div className="card-body">
              ...
              <a href="https://github.com/jaredseefried/weather-dashboard" target="_blank" rel="noreferrer" ><FiGithub className="github-link" /></a>
            </div>
          </div>
        </div>
      </div>
